...
var translations = {
    en: {
        ...
        'lib.selectTags': 'Select tags', 'lib.saveTags': 'Save tags', 'lib.tagsUpdated': 'Tags updated', 'lib.newTag': 'New tag', 'lib.createTag': 'Create tag', 'lib.tagCreated': 'Tag created', 'lib.tagDeleted': 'Tag deleted', 'lib.tagNamePlaceholder': 'e.g. development', 'lib.defaultTag': 'Default', 'lib.tagUsage': '{0} item(s)', 'lib.defaultTagLocked': 'The default tag cannot be deleted.', 'lib.tagInUse': 'Remove this tag from every Skill and Prompt before deleting it.', 'lib.noManagedTags': 'Create a tag before selecting one.',
