...
var translations = {
    en: {
        ...
        'proj.agentFolders': 'Agent folders', 'proj.agentFoldersDesc': 'Choose the Agent directories used by project scanning and deployment.', 'proj.configureAgents': 'Configure Agent folders', 'proj.addAgent': 'Add Agent folder', 'proj.editAgent': 'Edit Agent folder', 'proj.agentName': 'Agent name', 'proj.agentID': 'Agent ID', 'proj.userPath': 'User path', 'proj.projectPath': 'Project path', 'proj.agentEnabled': 'Enabled', 'proj.agentPathHint': 'Use ~, $HOME, or $XDG_CONFIG. Project paths are relative to the registered project.', 'proj.agentSaved': 'Agent folder saved', 'proj.agentRemoved': 'Agent folder removed', 'proj.agentRequired': 'Name and both paths are required', 'proj.confirmRemoveAgent': 'Remove this custom Agent folder?', 'proj.noAgentFolders': 'No Agent folders configured',
        'proj.save': 'Save',
        ...
        'proj.statusEmpty': 'No deployment operations', 'proj.target': 'Target', 'proj.source': 'Source', 'proj.viewDetails': 'View details', 'proj.skillDetails': 'Project Skill details', 'proj.skillPath': 'Skill path', 'proj.metadata': 'Metadata', 'proj.content': 'Skill content', 'proj.noContent': 'No Skill content',
    },
    zh: {
        ...
        'proj.agentFolders': 'Agent 文件夹', 'proj.agentFoldersDesc': '选择项目扫描和部署使用的 Agent 文件夹。', 'proj.configureAgents': '配置 Agent 文件夹', 'proj.addAgent': '添加 Agent 文件夹', 'proj.editAgent': '编辑 Agent 文件夹', 'proj.agentName': 'Agent 名称', 'proj.agentID': 'Agent ID', 'proj.userPath': '用户路径', 'proj.projectPath': '项目路径', 'proj.agentEnabled': '启用', 'proj.agentPathHint': '支持 ~、$HOME 或 $XDG_CONFIG。项目路径相对于已登记的项目目录。', 'proj.agentSaved': 'Agent 文件夹已保存', 'proj.agentRemoved': 'Agent 文件夹已移除', 'proj.agentRequired': '名称和两个路径都不能为空', 'proj.confirmRemoveAgent': '移除这个自定义 Agent 文件夹？', 'proj.noAgentFolders': '暂无 Agent 文件夹配置',
        'proj.save': '保存',
        ...
        'proj.statusEmpty': '没有部署操作', 'proj.target': '目标', 'proj.source': '来源', 'proj.viewDetails': '查看详情', 'proj.skillDetails': '项目 Skill 详情', 'proj.skillPath': 'Skill 路径', 'proj.metadata': '元数据', 'proj.content': 'Skill 内容', 'proj.noContent': '暂无 Skill 内容',
    }
};
