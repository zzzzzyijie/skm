...
var translations = {
    en: {
        ...
        'lib.gitUrl': 'Git repository URL', 'lib.gitRef': 'Ref (branch, tag, or commit)', 'lib.import': 'Import', 'lib.scanRepository': 'Scan repository', 'lib.scanningRepository': 'Scanning repository…',
        'lib.repositoryReview': 'Choose Skills to import', 'lib.repositoryReviewHint': 'Only selected valid Skills will be bound to this source.', 'lib.repositorySummary': '{0} available · {1} unavailable', 'lib.repositoryAvailable': 'Available', 'lib.repositoryUnavailable': 'Unavailable', 'lib.repositorySelected': '{0} selected', 'lib.importSelected': 'Import selected ({0})', 'lib.selectImportSkill': 'Select at least one valid Skill', 'lib.duplicateImportSkill': 'Choose only one path for each Skill name.', 'lib.backToRepository': 'Back', 'lib.requestedSelectionHint': 'Selections from the install command are applied when they identify one valid path.',
    ...
    zh: {
        ...
        'lib.gitUrl': 'Git 仓库地址', 'lib.gitRef': '引用（分支、Tag 或提交）', 'lib.import': '导入', 'lib.scanRepository': '扫描仓库', 'lib.scanningRepository': '正在扫描仓库…',
        'lib.repositoryReview': '选择需要导入的 Skill', 'lib.repositoryReviewHint': '只有选中且校验通过的 Skill 会绑定到这个来源。', 'lib.repositorySummary': '{0} 个可用 · {1} 个不可用', 'lib.repositoryAvailable': '可用', 'lib.repositoryUnavailable': '不可用', 'lib.repositorySelected': '已选择 {0} 个', 'lib.importSelected': '导入所选（{0}）', 'lib.selectImportSkill': '请至少选择一个有效 Skill', 'lib.duplicateImportSkill': '同名 Skill 只能选择一个路径。', 'lib.backToRepository': '返回', 'lib.requestedSelectionHint': '安装命令指定的 Skill 若只对应一个有效路径，会自动选中。',
