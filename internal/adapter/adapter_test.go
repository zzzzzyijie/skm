...
func TestTargetPaths(t *testing.T) {
	tests := []struct {
		...
		{domain.AgentCodex, domain.PlacementUser, filepath.Join("/users/test", ".agents", "skills", "review")},
		{domain.AgentClaude, domain.PlacementProject, filepath.Join("/repo", ".claude", "skills", "review")},
		{domain.AgentCodex, domain.PlacementProject, filepath.Join("/repo", ".agents", "skills", "review")},
	}
