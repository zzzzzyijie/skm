    ...
    targets: [
        .target(
            ...
            infoPlist: .extendingDefault(with: [
                ...
                "NSDesktopFolderUsageDescription": "SKM 需要读取已登记的项目目录以扫描 Skills，并仅在你确认部署后写入受管文件。",
                "NSDocumentsFolderUsageDescription": "SKM 需要读取已登记的项目目录以扫描 Skills，并仅在你确认部署后写入受管文件。",
                "NSDownloadsFolderUsageDescription": "SKM 需要读取已登记的项目目录以扫描 Skills，并仅在你确认部署后写入受管文件。",
                "NSHumanReadableCopyright": "Copyright © 2026 SKM Contributors",
                "NSNetworkVolumesUsageDescription": "SKM 需要访问你已登记在网络卷上的项目目录。",
                "NSPrincipalClass": "NSApplication",
                "NSRemovableVolumesUsageDescription": "SKM 需要访问你已登记在可移动磁盘上的项目目录。",
